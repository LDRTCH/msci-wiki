...
<object data="./week-5-6-files/grid.pdf" type="application/pdf" width="900px" height="900px">
...
<object data="./week-5-6-files/gridcorrect.pdf" type="application/pdf" width="900px" height="900px">
...
The code bellow constitutes the main analysis done in this section. It leverages h5py file manipulation and uses a locally-created function (`utils.get_ds_iters`) for obtaining individual iterations from within it. This code is heavily borrowed from my lab partner's [version](https://dlam.mrxl.org/activity_log/week_6.html#cluster-analysis) (external link), which in turn makes use of our supervisor's [code](./../shared/ftnotes/label.ipynb).
...
![](./week-5-6-files/cluster1.png)

![](./week-5-6-files/cluster2.png)

![](./week-5-6-files/cluster3.png)
